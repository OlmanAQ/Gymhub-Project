...
const ClientNavBarComponent = ({ onShowSales }) => {
  ...
  return (
    <nav className="client-navbar">
      ...
      <div
        className="client-navbar-profile"
        onMouseEnter={() => setDropdownVisible(true)}
        onMouseLeave={() => setDropdownVisible(false)}
      >
        <User className="client-navbar-icon" />
        <span className="client-navbar-username">Mi Perfil</span>
        {isDropdownVisible && (
          <ul className="client-navbar-dropdown">
